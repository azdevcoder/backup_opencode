---
name: cc-partnerships-architect
...
> Port of the community skill `partnerships-architect` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-partnerships-architect`; body unchanged.
