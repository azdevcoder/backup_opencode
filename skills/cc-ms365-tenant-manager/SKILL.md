...
> Port of the community skill `ms365-tenant-manager` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ms365-tenant-manager`; body unchanged.
