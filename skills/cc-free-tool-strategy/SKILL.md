...
> Port of the community skill `free-tool-strategy` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-free-tool-strategy`; body unchanged.
