...
> Port of the community skill `agent-protocol` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-agent-protocol`; body unchanged.
