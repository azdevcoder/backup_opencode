...
> Port of the community skill `content-production` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-content-production`; body unchanged.
