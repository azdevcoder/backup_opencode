...
> Port of the community skill `md-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-md-review`; body unchanged.
