---
name: cc-business-growth-skills
...
> Port of the community skill `business-growth-skills` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-business-growth-skills`; body unchanged.
