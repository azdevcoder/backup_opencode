...
> Port of the community skill `grants` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-grants`; body unchanged.
