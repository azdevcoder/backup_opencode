...
> Port of the community skill `research-ops-skills` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-research-ops-skills`; body unchanged.
