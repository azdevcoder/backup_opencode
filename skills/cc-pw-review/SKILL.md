...
> Port of the community skill `pw-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-pw-review`; body unchanged.
