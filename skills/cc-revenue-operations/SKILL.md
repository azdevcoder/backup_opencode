...
> Port of the community skill `revenue-operations` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-revenue-operations`; body unchanged.
