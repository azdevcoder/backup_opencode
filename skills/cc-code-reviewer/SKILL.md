...
> Port of the community skill `code-reviewer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-code-reviewer`; body unchanged.
