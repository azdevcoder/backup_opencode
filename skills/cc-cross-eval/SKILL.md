...
> Port of the community skill `cross-eval` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cross-eval`; body unchanged.
