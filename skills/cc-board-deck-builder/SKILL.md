...
> Port of the community skill `board-deck-builder` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-board-deck-builder`; body unchanged.
