...
> Port of the community skill `atlassian-templates` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-atlassian-templates`; body unchanged.
