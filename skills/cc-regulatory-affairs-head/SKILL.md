---
name: cc-regulatory-affairs-head
...
> Port of the community skill `regulatory-affairs-head` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-regulatory-affairs-head`; body unchanged.
