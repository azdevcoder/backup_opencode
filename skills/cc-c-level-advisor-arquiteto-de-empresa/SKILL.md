---
name: cc-c-level-advisor-arquiteto-de-empresa
...
> Port of the community skill `arquiteto-de-empresa` (source `c-level-advisor/skills/arquiteto-de-empresa/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-c-level-advisor-arquiteto-de-empresa` (duplicate upstream name); body rebuilt with the upstream opencode transform.
