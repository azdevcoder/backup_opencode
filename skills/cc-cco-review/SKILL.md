...
> Port of the community skill `cco-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cco-review`; body unchanged.
