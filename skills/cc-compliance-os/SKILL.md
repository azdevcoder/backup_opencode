...
> Port of the community skill `compliance-os` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-compliance-os`; body unchanged.
