...
> Port of the community skill `stress-test` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-stress-test`; body unchanged.
