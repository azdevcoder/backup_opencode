...
> Port of the community skill `post-mortem` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-post-mortem`; body unchanged.
