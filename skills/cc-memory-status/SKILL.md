...
> Port of the community skill `memory-status` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-memory-status`; body unchanged.
