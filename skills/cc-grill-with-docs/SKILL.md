...
> Port of the community skill `grill-with-docs` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-grill-with-docs`; body unchanged.
