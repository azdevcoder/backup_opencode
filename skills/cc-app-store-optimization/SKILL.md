---
name: cc-app-store-optimization
...
> Port of the community skill `app-store-optimization` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-app-store-optimization`; body unchanged.
