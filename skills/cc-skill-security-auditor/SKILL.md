---
name: cc-skill-security-auditor
...
> Port of the community skill `skill-security-auditor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-skill-security-auditor`; body unchanged.
