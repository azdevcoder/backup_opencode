...
> Port of the community skill `cto-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cto-advisor`; body unchanged.
