...
> Port of the community skill `senior-ml-engineer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-ml-engineer`; body unchanged.
