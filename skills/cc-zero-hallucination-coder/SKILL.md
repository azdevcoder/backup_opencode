---
name: cc-zero-hallucination-coder
...
> Port of the community skill `zero-hallucination-coder` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-zero-hallucination-coder`; body unchanged.
