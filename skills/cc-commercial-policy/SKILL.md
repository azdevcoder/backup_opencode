...
> Port of the community skill `commercial-policy` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-commercial-policy`; body unchanged.
