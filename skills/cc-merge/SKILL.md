...
> Port of the community skill `merge` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-merge`; body unchanged.
