...
> Port of the community skill `senior-data-scientist` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-data-scientist`; body unchanged.
