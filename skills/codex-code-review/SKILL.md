...
> Port of the Codex built-in skill `code-review` from openai/codex (.codex/skills) for OpenCode. Directory and `name:` prefixed as `codex-code-review`; body unchanged.
