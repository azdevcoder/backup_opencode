---
name: cc-senior-prompt-engineer
...
> Port of the community skill `senior-prompt-engineer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-prompt-engineer`; body unchanged.
