...
> Port of the community skill `write-a-skill` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-write-a-skill`; body unchanged.
