...
> Port of the community skill `spec-driven-workflow` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-spec-driven-workflow`; body unchanged.
