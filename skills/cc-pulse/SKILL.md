...
> Port of the community skill `pulse` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-pulse`; body unchanged.
