...
> Port of the community skill `pw-init` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-pw-init`; body unchanged.
