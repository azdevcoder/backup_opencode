...
> Port of the community skill `capa-officer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-capa-officer`; body unchanged.
