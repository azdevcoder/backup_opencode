...
> Port of the community skill `agent-memory` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-agent-memory`; body unchanged.
