...
> Port of the community skill `cold-email` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cold-email`; body unchanged.
