...
> Port of the community skill `tech-debt-tracker` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-tech-debt-tracker`; body unchanged.
