...
> Port of the community skill `tdd-guide` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-tdd-guide`; body unchanged.
