...
> Port of the community skill `caveman` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-caveman`; body unchanged.
