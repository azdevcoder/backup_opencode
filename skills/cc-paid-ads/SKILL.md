...
> Port of the community skill `paid-ads` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-paid-ads`; body unchanged.
