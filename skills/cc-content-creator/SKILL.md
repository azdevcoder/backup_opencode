...
> Port of the community skill `content-creator` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-content-creator`; body unchanged.
