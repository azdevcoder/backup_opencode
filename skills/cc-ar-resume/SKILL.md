...
> Port of the community skill `ar-resume` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ar-resume`; body unchanged.
