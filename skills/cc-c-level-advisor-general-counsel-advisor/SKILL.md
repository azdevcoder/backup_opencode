---
name: cc-c-level-advisor-general-counsel-advisor
...
> Port of the community skill `general-counsel-advisor` (source `c-level-advisor/skills/general-counsel-advisor/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-c-level-advisor-general-counsel-advisor` (duplicate upstream name); body rebuilt with the upstream opencode transform.
