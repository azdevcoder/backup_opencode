...
> Port of the community skill `secrets-vault-manager` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-secrets-vault-manager`; body unchanged.
