...
> Port of the community skill `internal-comms` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-internal-comms`; body unchanged.
