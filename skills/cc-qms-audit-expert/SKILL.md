...
> Port of the community skill `qms-audit-expert` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-qms-audit-expert`; body unchanged.
