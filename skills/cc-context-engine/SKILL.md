...
> Port of the community skill `context-engine` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-context-engine`; body unchanged.
