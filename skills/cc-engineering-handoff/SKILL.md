...
> Port of the community skill `handoff` (source `engineering/handoff/skills/handoff/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-engineering-handoff` (duplicate upstream name); body rebuilt with the upstream opencode transform.
