...
> Port of the community skill `migration-architect` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-migration-architect`; body unchanged.
