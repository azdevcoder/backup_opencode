...
> Port of the community skill `marketing-ideas` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-marketing-ideas`; body unchanged.
