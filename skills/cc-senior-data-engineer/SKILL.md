...
> Port of the community skill `senior-data-engineer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-data-engineer`; body unchanged.
