...
> Port of the community skill `andreessen` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-andreessen`; body unchanged.
