...
> Port of the community skill `dependency-auditor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-dependency-auditor`; body unchanged.
