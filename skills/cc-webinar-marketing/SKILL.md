...
> Port of the community skill `webinar-marketing` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-webinar-marketing`; body unchanged.
