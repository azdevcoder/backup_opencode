...
> Port of the community skill `challenge` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-challenge`; body unchanged.
