...
> Port of the community skill `ai-security` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ai-security`; body unchanged.
