...
> Port of the community skill `referral-program` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-referral-program`; body unchanged.
