...
> Port of the community skill `social-media-manager` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-social-media-manager`; body unchanged.
