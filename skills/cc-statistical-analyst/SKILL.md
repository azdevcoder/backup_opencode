...
> Port of the community skill `statistical-analyst` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-statistical-analyst`; body unchanged.
