...
> Port of the community skill `c-level-skills` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-c-level-skills`; body unchanged.
