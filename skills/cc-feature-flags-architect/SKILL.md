---
name: cc-feature-flags-architect
...
> Port of the community skill `feature-flags-architect` (source `engineering/feature-flags-architect/skills/feature-flags-architect/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-feature-flags-architect` (duplicate upstream name); body rebuilt with the upstream opencode transform.
