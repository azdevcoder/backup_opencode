...
> Port of the community skill `team-communications` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-team-communications`; body unchanged.
