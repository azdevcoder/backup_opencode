...
> Port of the community skill `gdpr-audit-prep` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-gdpr-audit-prep`; body unchanged.
