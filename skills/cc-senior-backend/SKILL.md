...
> Port of the community skill `senior-backend` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-backend`; body unchanged.
