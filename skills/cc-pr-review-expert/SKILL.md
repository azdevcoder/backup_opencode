...
> Port of the community skill `pr-review-expert` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-pr-review-expert`; body unchanged.
