...
> Port of the community skill `confluence-expert` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-confluence-expert`; body unchanged.
