---
name: cc-sql-database-assistant
...
> Port of the community skill `sql-database-assistant` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-sql-database-assistant`; body unchanged.
