...
> Port of the community skill `ma-playbook` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ma-playbook`; body unchanged.
