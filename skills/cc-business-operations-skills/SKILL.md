---
name: cc-business-operations-skills
...
> Port of the community skill `business-operations-skills` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-business-operations-skills`; body unchanged.
