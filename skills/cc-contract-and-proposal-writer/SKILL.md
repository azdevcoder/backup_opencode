---
name: cc-contract-and-proposal-writer
...
> Port of the community skill `contract-and-proposal-writer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-contract-and-proposal-writer`; body unchanged.
