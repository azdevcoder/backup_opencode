...
> Port of the community skill `coverage` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-coverage`; body unchanged.
