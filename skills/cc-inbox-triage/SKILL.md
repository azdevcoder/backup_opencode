...
> Port of the community skill `inbox-triage` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-inbox-triage`; body unchanged.
