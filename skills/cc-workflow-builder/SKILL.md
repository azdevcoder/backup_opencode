...
> Port of the community skill `workflow-builder` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-workflow-builder`; body unchanged.
