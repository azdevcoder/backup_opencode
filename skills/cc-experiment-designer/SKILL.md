...
> Port of the community skill `experiment-designer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-experiment-designer`; body unchanged.
