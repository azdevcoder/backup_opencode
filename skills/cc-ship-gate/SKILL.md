...
> Port of the community skill `ship-gate` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ship-gate`; body unchanged.
