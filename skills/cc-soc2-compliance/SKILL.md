...
> Port of the community skill `soc2-compliance` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-soc2-compliance`; body unchanged.
