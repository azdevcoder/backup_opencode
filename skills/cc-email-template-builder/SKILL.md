---
name: cc-email-template-builder
...
> Port of the community skill `email-template-builder` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-email-template-builder`; body unchanged.
