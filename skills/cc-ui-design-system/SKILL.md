...
> Port of the community skill `ui-design-system` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ui-design-system`; body unchanged.
