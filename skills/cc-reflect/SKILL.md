...
> Port of the community skill `reflect` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-reflect`; body unchanged.
