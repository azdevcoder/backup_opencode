...
> Port of the community skill `marketing-ops` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-marketing-ops`; body unchanged.
