...
> Port of the community skill `ciso-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ciso-review`; body unchanged.
