...
> Port of the community skill `cs-onboard` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cs-onboard`; body unchanged.
