...
> Port of the community skill `incident-response` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-incident-response`; body unchanged.
