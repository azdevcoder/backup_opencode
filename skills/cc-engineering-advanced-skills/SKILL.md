---
name: cc-engineering-advanced-skills
...
> Port of the community skill `engineering-advanced-skills` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-engineering-advanced-skills`; body unchanged.
