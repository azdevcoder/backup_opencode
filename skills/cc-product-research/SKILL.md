...
> Port of the community skill `product-research` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-product-research`; body unchanged.
