---
name: cc-agent-workflow-designer
...
> Port of the community skill `agent-workflow-designer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-agent-workflow-designer`; body unchanged.
