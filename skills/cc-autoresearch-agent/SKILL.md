...
> Port of the community skill `autoresearch-agent` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-autoresearch-agent`; body unchanged.
