---
name: cc-database-schema-designer
...
> Port of the community skill `database-schema-designer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-database-schema-designer`; body unchanged.
