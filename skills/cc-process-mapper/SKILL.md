...
> Port of the community skill `process-mapper` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-process-mapper`; body unchanged.
