---
name: cc-quality-documentation-manager
...
> Port of the community skill `quality-documentation-manager` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-quality-documentation-manager`; body unchanged.
