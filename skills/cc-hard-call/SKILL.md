...
> Port of the community skill `hard-call` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-hard-call`; body unchanged.
