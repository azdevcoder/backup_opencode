...
> Port of the Codex built-in skill `path-types` from openai/codex (.codex/skills) for OpenCode. Directory and `name:` prefixed as `codex-path-types`; body unchanged.
