---
name: codex-remote-tests
description: Testing against remote executors in integration tests.
---

> Port of the Codex built-in skill `remote-tests` from openai/codex (.codex/skills) for OpenCode. Directory and `name:` prefixed as `codex-remote-tests`; body unchanged.
