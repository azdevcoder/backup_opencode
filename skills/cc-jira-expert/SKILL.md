...
> Port of the community skill `jira-expert` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-jira-expert`; body unchanged.
