...
> Port of the community skill `security-guidance` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-security-guidance`; body unchanged.
