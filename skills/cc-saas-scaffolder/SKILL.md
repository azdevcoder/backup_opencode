...
> Port of the community skill `saas-scaffolder` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-saas-scaffolder`; body unchanged.
