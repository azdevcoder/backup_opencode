...
> Port of the community skill `hub-init` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-hub-init`; body unchanged.
