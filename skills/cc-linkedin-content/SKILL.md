...
> Port of the community skill `linkedin-content` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-linkedin-content`; body unchanged.
