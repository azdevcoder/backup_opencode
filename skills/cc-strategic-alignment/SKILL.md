...
> Port of the community skill `strategic-alignment` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-strategic-alignment`; body unchanged.
