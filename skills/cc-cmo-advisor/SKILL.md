...
> Port of the community skill `cmo-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cmo-advisor`; body unchanged.
