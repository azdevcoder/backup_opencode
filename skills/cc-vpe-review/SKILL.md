...
> Port of the community skill `vpe-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-vpe-review`; body unchanged.
