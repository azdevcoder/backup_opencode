...
> Port of the community skill `fda-qsr-audit-prep` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-fda-qsr-audit-prep`; body unchanged.
