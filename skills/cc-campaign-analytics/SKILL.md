...
> Port of the community skill `campaign-analytics` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-campaign-analytics`; body unchanged.
