...
> Port of the community skill `change-management` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-change-management`; body unchanged.
