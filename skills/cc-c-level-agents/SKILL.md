...
> Port of the community skill `c-level-agents` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-c-level-agents`; body unchanged.
