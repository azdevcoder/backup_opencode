...
> Port of the community skill `founder-mode` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-founder-mode`; body unchanged.
