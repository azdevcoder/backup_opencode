...
> Port of the Codex built-in skill `update-v8-version` from openai/codex (.codex/skills) for OpenCode. Directory and `name:` prefixed as `codex-update-v8-version`; body unchanged.
