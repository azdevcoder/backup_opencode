...
> Port of the community skill `focused-fix` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-focused-fix`; body unchanged.
