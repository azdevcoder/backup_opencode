...
> Port of the community skill `quality-manager-qmr` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-quality-manager-qmr`; body unchanged.
