...
> Port of the community skill `ciso-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ciso-advisor`; body unchanged.
