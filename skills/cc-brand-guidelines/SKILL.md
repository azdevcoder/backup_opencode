...
> Port of the community skill `brand-guidelines` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-brand-guidelines`; body unchanged.
