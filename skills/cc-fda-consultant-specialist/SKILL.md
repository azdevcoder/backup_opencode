---
name: cc-fda-consultant-specialist
...
> Port of the community skill `fda-consultant-specialist` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-fda-consultant-specialist`; body unchanged.
