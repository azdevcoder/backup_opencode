...
> Port of the community skill `competitive-teardown` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-competitive-teardown`; body unchanged.
