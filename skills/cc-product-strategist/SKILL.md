...
> Port of the community skill `product-strategist` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-product-strategist`; body unchanged.
