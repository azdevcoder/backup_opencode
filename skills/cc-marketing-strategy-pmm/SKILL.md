---
name: cc-marketing-strategy-pmm
...
> Port of the community skill `marketing-strategy-pmm` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-marketing-strategy-pmm`; body unchanged.
