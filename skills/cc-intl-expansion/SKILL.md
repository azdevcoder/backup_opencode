...
> Port of the community skill `intl-expansion` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-intl-expansion`; body unchanged.
