---
name: cc-quality-manager-qms-iso13485
...
> Port of the community skill `quality-manager-qms-iso13485` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-quality-manager-qms-iso13485`; body unchanged.
