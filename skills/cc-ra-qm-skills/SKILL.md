...
> Port of the community skill `ra-qm-skills` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ra-qm-skills`; body unchanged.
