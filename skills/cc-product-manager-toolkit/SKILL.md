---
name: cc-product-manager-toolkit
...
> Port of the community skill `product-manager-toolkit` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-product-manager-toolkit`; body unchanged.
