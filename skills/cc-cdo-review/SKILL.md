...
> Port of the community skill `cdo-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cdo-review`; body unchanged.
