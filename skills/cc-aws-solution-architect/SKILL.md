---
name: cc-aws-solution-architect
...
> Port of the community skill `aws-solution-architect` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-aws-solution-architect`; body unchanged.
