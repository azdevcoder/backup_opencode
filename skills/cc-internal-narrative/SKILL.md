...
> Port of the community skill `internal-narrative` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-internal-narrative`; body unchanged.
