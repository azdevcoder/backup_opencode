...
> Port of the community skill `monorepo-navigator` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-monorepo-navigator`; body unchanged.
