...
> Port of the community skill `deal-desk` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-deal-desk`; body unchanged.
