...
> Port of the community skill `compliance-readiness` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-compliance-readiness`; body unchanged.
