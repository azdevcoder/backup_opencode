...
> Port of the community skill `tc-tracker` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-tc-tracker`; body unchanged.
