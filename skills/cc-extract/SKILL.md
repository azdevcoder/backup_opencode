...
> Port of the community skill `extract` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-extract`; body unchanged.
