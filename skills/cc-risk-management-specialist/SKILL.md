---
name: cc-risk-management-specialist
...
> Port of the community skill `risk-management-specialist` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-risk-management-specialist`; body unchanged.
