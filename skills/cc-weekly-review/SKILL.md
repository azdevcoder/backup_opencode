...
> Port of the community skill `weekly-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-weekly-review`; body unchanged.
