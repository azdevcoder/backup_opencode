...
> Port of the community skill `cfo-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cfo-advisor`; body unchanged.
