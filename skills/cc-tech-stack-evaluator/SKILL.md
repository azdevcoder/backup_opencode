...
> Port of the community skill `tech-stack-evaluator` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-tech-stack-evaluator`; body unchanged.
