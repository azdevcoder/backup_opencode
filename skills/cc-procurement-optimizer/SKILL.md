...
> Port of the community skill `procurement-optimizer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-procurement-optimizer`; body unchanged.
