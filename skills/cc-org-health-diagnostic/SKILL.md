...
> Port of the community skill `org-health-diagnostic` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-org-health-diagnostic`; body unchanged.
