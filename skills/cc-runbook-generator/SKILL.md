...
> Port of the community skill `runbook-generator` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-runbook-generator`; body unchanged.
