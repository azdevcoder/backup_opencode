...
> Port of the community skill `generate` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-generate`; body unchanged.
