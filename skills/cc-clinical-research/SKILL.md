...
> Port of the community skill `clinical-research` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-clinical-research`; body unchanged.
