...
> Port of the community skill `scrum-master` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-scrum-master`; body unchanged.
