---
name: cc-video-content-strategist
...
> Port of the community skill `video-content-strategist` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-video-content-strategist`; body unchanged.
