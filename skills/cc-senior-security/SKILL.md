...
> Port of the community skill `senior-security` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-security`; body unchanged.
