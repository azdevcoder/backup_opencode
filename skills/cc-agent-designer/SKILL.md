...
> Port of the community skill `agent-designer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-agent-designer`; body unchanged.
