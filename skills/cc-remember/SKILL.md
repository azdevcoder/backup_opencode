...
> Port of the community skill `remember` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-remember`; body unchanged.
