...
> Port of the community skill `product-discovery` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-product-discovery`; body unchanged.
