...
> Port of the community skill `llm-cost-optimizer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-llm-cost-optimizer`; body unchanged.
