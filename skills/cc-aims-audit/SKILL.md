...
> Port of the community skill `aims-audit` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-aims-audit`; body unchanged.
