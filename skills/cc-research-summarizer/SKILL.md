...
> Port of the community skill `research-summarizer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-research-summarizer`; body unchanged.
