...
> Port of the community skill `culture-architect` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-culture-architect`; body unchanged.
