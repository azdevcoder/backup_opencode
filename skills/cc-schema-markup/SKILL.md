...
> Port of the community skill `schema-markup` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-schema-markup`; body unchanged.
