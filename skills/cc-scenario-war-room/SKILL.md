...
> Port of the community skill `scenario-war-room` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-scenario-war-room`; body unchanged.
