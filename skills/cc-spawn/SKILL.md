...
> Port of the community skill `spawn` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-spawn`; body unchanged.
