...
> Port of the community skill `deep-learning-book` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-deep-learning-book`; body unchanged.
