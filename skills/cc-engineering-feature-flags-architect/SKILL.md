---
name: cc-engineering-feature-flags-architect
...
> Port of the community skill `feature-flags-architect` (source `engineering/skills/feature-flags-architect/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-engineering-feature-flags-architect` (duplicate upstream name); body rebuilt with the upstream opencode transform.
