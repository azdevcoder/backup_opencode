...
> Port of the community skill `aeo` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-aeo`; body unchanged.
