...
> Port of the community skill `marketing-skills` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-marketing-skills`; body unchanged.
