...
> Port of the community skill `roadmap-communicator` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-roadmap-communicator`; body unchanged.
