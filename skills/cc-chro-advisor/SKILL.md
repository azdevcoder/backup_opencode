...
> Port of the community skill `chro-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-chro-advisor`; body unchanged.
