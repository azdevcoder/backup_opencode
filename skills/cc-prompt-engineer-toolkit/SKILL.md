---
name: cc-prompt-engineer-toolkit
...
> Port of the community skill `prompt-engineer-toolkit` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-prompt-engineer-toolkit`; body unchanged.
