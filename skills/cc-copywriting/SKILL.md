...
> Port of the community skill `copywriting` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-copywriting`; body unchanged.
