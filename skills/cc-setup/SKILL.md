...
> Port of the community skill `setup` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-setup`; body unchanged.
