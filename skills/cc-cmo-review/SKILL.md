...
> Port of the community skill `cmo-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cmo-review`; body unchanged.
