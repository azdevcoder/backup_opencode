...
> Port of the community skill `database-designer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-database-designer`; body unchanged.
