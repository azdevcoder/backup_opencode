...
> Port of the community skill `memory-engineering` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-memory-engineering`; body unchanged.
