---
name: cc-engineering-chaos-engineering
...
> Port of the community skill `chaos-engineering` (source `engineering/skills/chaos-engineering/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-engineering-chaos-engineering` (duplicate upstream name); body rebuilt with the upstream opencode transform.
