...
> Port of the community skill `knowledge-ops` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-knowledge-ops`; body unchanged.
