...
> Port of the community skill `azure-cloud-architect` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-azure-cloud-architect`; body unchanged.
