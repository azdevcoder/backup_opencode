...
> Port of the community skill `skill-doctor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-skill-doctor`; body unchanged.
