...
> Port of the community skill `handoff` (source `productivity/handoff/skills/handoff/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-handoff` (duplicate upstream name); body rebuilt with the upstream opencode transform.
