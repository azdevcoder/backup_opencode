...
> Port of the community skill `landing-page-generator` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-landing-page-generator`; body unchanged.
