...
> Port of the community skill `human-gate` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-human-gate`; body unchanged.
