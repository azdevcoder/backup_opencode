---
name: muse-greenfield-project-scaffolding
...
6. Use the ecosystem-native layout inside that root. Keep entry points, package files,
   ...
   defer artifact and verification mechanics to `muse-browser-app-delivery`.
