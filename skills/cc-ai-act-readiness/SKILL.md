...
> Port of the community skill `ai-act-readiness` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ai-act-readiness`; body unchanged.
