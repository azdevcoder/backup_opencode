...
> Port of the community skill `gcp-cloud-architect` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-gcp-cloud-architect`; body unchanged.
