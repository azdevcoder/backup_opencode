...
> Port of the community skill `gdpr-dsgvo-expert` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-gdpr-dsgvo-expert`; body unchanged.
