...
> Port of the community skill `epic-design` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-epic-design`; body unchanged.
