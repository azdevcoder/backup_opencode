...
> Port of the community skill `decision-logger` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-decision-logger`; body unchanged.
