...
> Port of the community skill `youtube-full` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-youtube-full`; body unchanged.
