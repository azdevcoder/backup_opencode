...
> Port of the community skill `incident-commander` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-incident-commander`; body unchanged.
