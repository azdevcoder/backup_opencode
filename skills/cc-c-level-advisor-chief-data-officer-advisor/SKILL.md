---
name: cc-c-level-advisor-chief-data-officer-advisor
...
> Port of the community skill `chief-data-officer-advisor` (source `c-level-advisor/skills/chief-data-officer-advisor/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-c-level-advisor-chief-data-officer-advisor` (duplicate upstream name); body rebuilt with the upstream opencode transform.
