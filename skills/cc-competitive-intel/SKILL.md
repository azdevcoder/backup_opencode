...
> Port of the community skill `competitive-intel` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-competitive-intel`; body unchanged.
