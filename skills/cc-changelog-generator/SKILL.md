...
> Port of the community skill `changelog-generator` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-changelog-generator`; body unchanged.
