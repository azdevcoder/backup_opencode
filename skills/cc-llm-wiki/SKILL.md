...
> Port of the community skill `llm-wiki` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-llm-wiki`; body unchanged.
