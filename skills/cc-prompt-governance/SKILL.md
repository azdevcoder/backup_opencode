...
> Port of the community skill `prompt-governance` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-prompt-governance`; body unchanged.
