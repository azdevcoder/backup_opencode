...
> Port of the community skill `playwright-pro` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-playwright-pro`; body unchanged.
