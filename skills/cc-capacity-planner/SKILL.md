...
> Port of the community skill `capacity-planner` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-capacity-planner`; body unchanged.
