...
> Port of the community skill `behuman` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-behuman`; body unchanged.
