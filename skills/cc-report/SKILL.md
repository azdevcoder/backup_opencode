...
> Port of the community skill `report` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-report`; body unchanged.
