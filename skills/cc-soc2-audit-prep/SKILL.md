...
> Port of the community skill `soc2-audit-prep` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-soc2-audit-prep`; body unchanged.
