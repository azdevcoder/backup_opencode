...
> Port of the community skill `run-without-you` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-run-without-you`; body unchanged.
