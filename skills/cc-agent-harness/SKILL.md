...
> Port of the community skill `agent-harness` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-agent-harness`; body unchanged.
