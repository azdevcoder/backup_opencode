...
> Port of the community skill `performance-profiler` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-performance-profiler`; body unchanged.
