...
> Port of the community skill `senior-secops` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-secops`; body unchanged.
