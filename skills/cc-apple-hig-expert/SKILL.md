...
> Port of the community skill `apple-hig-expert` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-apple-hig-expert`; body unchanged.
