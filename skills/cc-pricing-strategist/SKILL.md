...
> Port of the community skill `pricing-strategist` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-pricing-strategist`; body unchanged.
