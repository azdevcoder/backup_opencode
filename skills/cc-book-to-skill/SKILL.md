...
> Port of the community skill `book-to-skill` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-book-to-skill`; body unchanged.
