...
> Port of the community skill `security-pen-testing` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-security-pen-testing`; body unchanged.
