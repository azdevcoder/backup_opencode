...
> Port of the community skill `research-finance` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-research-finance`; body unchanged.
