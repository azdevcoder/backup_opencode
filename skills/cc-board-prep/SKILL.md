...
> Port of the community skill `board-prep` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-board-prep`; body unchanged.
