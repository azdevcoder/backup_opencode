...
> Port of the community skill `litreview` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-litreview`; body unchanged.
