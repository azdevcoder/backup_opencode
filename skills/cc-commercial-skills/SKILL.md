...
> Port of the community skill `commercial-skills` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-commercial-skills`; body unchanged.
