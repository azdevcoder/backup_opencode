...
> Port of the community skill `roast` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-roast`; body unchanged.
