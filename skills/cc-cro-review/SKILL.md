...
> Port of the community skill `cro-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cro-review`; body unchanged.
