...
> Port of the community skill `inbox-setup` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-inbox-setup`; body unchanged.
