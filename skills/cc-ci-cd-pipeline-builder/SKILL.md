---
name: cc-ci-cd-pipeline-builder
...
> Port of the community skill `ci-cd-pipeline-builder` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ci-cd-pipeline-builder`; body unchanged.
