...
> Port of the community skill `docker-development` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-docker-development`; body unchanged.
