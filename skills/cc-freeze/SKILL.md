...
> Port of the community skill `freeze` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-freeze`; body unchanged.
