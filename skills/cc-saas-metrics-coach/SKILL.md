...
> Port of the community skill `saas-metrics-coach` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-saas-metrics-coach`; body unchanged.
