...
> Port of the community skill `analytics-tracking` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-analytics-tracking`; body unchanged.
