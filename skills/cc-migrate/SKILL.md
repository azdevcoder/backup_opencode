...
> Port of the community skill `migrate` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-migrate`; body unchanged.
