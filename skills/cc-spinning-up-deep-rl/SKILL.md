...
> Port of the community skill `spinning-up-deep-rl` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-spinning-up-deep-rl`; body unchanged.
