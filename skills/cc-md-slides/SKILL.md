...
> Port of the community skill `md-slides` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-md-slides`; body unchanged.
