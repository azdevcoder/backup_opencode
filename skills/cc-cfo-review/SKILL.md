...
> Port of the community skill `cfo-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cfo-review`; body unchanged.
