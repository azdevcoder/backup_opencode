...
> Port of the community skill `interview` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-interview`; body unchanged.
