---
name: cc-chief-ai-officer-advisor
...
> Port of the community skill `chief-ai-officer-advisor` (source `c-level-advisor/chief-ai-officer-advisor/skills/chief-ai-officer-advisor/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-chief-ai-officer-advisor` (duplicate upstream name); body rebuilt with the upstream opencode transform.
