...
> Port of the community skill `senior-qa` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-qa`; body unchanged.
