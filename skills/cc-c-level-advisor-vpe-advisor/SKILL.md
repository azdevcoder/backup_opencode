---
name: cc-c-level-advisor-vpe-advisor
...
> Port of the community skill `vpe-advisor` (source `c-level-advisor/vpe-advisor/skills/vpe-advisor/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-c-level-advisor-vpe-advisor` (duplicate upstream name); body rebuilt with the upstream opencode transform.
