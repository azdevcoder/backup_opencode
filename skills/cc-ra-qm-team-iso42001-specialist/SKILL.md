---
name: cc-ra-qm-team-iso42001-specialist
...
> Port of the community skill `iso42001-specialist` (source `ra-qm-team/skills/iso42001-specialist/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-ra-qm-team-iso42001-specialist` (duplicate upstream name); body rebuilt with the upstream opencode transform.
