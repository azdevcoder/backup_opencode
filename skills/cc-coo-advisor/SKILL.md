...
> Port of the community skill `coo-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-coo-advisor`; body unchanged.
