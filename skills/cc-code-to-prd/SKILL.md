...
> Port of the community skill `code-to-prd` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-code-to-prd`; body unchanged.
