...
> Port of the community skill `landing` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-landing`; body unchanged.
