...
> Port of the community skill `sample-text-processor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-sample-text-processor`; body unchanged.
