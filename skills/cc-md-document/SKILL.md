...
> Port of the community skill `md-document` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-md-document`; body unchanged.
