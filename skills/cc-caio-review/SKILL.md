...
> Port of the community skill `caio-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-caio-review`; body unchanged.
