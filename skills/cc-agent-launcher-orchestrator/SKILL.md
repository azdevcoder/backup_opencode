---
name: cc-agent-launcher-orchestrator
...
> Port of the community skill `agent-launcher-orchestrator` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-agent-launcher-orchestrator`; body unchanged.
