...
> Port of the community skill `memory-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-memory-review`; body unchanged.
