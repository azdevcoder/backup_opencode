...
> Port of the community skill `a11y-audit` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-a11y-audit`; body unchanged.
