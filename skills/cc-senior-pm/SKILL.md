...
> Port of the community skill `senior-pm` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-pm`; body unchanged.
