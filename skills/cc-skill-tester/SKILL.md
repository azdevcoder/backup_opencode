...
> Port of the community skill `skill-tester` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-skill-tester`; body unchanged.
