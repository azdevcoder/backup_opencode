---
name: cc-information-security-manager-iso27001
...
> Port of the community skill `information-security-manager-iso27001` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-information-security-manager-iso27001`; body unchanged.
