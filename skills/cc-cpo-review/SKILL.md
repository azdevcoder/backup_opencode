...
> Port of the community skill `cpo-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cpo-review`; body unchanged.
