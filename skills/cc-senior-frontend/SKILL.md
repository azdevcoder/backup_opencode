...
> Port of the community skill `senior-frontend` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-frontend`; body unchanged.
