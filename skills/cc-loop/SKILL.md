...
> Port of the community skill `loop` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-loop`; body unchanged.
