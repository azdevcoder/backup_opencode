...
> Port of the community skill `demo-video` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-demo-video`; body unchanged.
