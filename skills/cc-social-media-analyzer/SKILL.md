...
> Port of the community skill `social-media-analyzer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-social-media-analyzer`; body unchanged.
