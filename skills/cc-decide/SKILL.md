...
> Port of the community skill `decide` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-decide`; body unchanged.
