...
> Port of the community skill `meeting-analyzer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-meeting-analyzer`; body unchanged.
