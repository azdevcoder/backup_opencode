...
> Port of the community skill `linkedin-analytics` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-linkedin-analytics`; body unchanged.
