---
name: cc-engineering-slo-architect
...
> Port of the community skill `slo-architect` (source `engineering/slo-architect/skills/slo-architect/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-engineering-slo-architect` (duplicate upstream name); body rebuilt with the upstream opencode transform.
