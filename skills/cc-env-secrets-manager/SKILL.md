...
> Port of the community skill `env-secrets-manager` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-env-secrets-manager`; body unchanged.
