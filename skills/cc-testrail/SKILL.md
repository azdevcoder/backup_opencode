...
> Port of the community skill `testrail` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-testrail`; body unchanged.
