...
> Port of the community skill `agenthub` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-agenthub`; body unchanged.
