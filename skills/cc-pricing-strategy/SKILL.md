...
> Port of the community skill `pricing-strategy` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-pricing-strategy`; body unchanged.
