...
> Port of the community skill `linkedin-engagement` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-linkedin-engagement`; body unchanged.
