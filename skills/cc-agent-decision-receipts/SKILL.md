---
name: cc-agent-decision-receipts
...
> Port of the community skill `agent-decision-receipts` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-agent-decision-receipts`; body unchanged.
