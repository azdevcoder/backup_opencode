...
> Port of the community skill `popup-cro` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-popup-cro`; body unchanged.
