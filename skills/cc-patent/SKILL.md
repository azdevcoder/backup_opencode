...
> Port of the community skill `patent` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-patent`; body unchanged.
