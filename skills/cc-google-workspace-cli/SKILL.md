...
> Port of the community skill `google-workspace-cli` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-google-workspace-cli`; body unchanged.
