...
> Port of the community skill `syllabus` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-syllabus`; body unchanged.
