...
> Port of the community skill `brief` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-brief`; body unchanged.
