...
> Port of the community skill `rag-architect` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-rag-architect`; body unchanged.
