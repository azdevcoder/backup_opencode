...
> Port of the community skill `mcp-server-builder` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-mcp-server-builder`; body unchanged.
