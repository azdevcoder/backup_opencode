...
> Port of the community skill `churn-prevention` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-churn-prevention`; body unchanged.
