...
> Port of the community skill `ceo-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ceo-advisor`; body unchanged.
