...
> Port of the community skill `ad-creative` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ad-creative`; body unchanged.
