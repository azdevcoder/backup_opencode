...
> Port of the community skill `financial-analyst` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-financial-analyst`; body unchanged.
