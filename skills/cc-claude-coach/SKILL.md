...
> Port of the community skill `claude-coach` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-claude-coach`; body unchanged.
