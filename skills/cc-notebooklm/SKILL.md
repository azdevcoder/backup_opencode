...
> Port of the community skill `notebooklm` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-notebooklm`; body unchanged.
