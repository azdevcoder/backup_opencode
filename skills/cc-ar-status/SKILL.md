...
> Port of the community skill `ar-status` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ar-status`; body unchanged.
