...
> Port of the community skill `cpo-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cpo-advisor`; body unchanged.
