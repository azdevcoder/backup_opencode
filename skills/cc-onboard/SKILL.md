...
> Port of the community skill `onboard` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-onboard`; body unchanged.
