---
name: codex-codex-pr-body
description: Update the title and body of one or more pull requests.
---

> Port of the Codex built-in skill `codex-pr-body` from openai/codex (.codex/skills) for OpenCode. Directory and `name:` prefixed as `codex-codex-pr-body`; body unchanged.
