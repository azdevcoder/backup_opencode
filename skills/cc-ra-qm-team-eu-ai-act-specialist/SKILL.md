---
name: cc-ra-qm-team-eu-ai-act-specialist
...
> Port of the community skill `eu-ai-act-specialist` (source `ra-qm-team/skills/eu-ai-act-specialist/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-ra-qm-team-eu-ai-act-specialist` (duplicate upstream name); body rebuilt with the upstream opencode transform.
