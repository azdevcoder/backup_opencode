...
> Port of the community skill `design-system` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-design-system`; body unchanged.
