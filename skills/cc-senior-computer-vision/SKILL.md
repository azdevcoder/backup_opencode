---
name: cc-senior-computer-vision
...
> Port of the community skill `senior-computer-vision` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-computer-vision`; body unchanged.
