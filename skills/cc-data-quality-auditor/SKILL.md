...
> Port of the community skill `data-quality-auditor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-data-quality-auditor`; body unchanged.
