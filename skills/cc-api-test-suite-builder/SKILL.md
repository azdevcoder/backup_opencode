---
name: cc-api-test-suite-builder
...
> Port of the community skill `api-test-suite-builder` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-api-test-suite-builder`; body unchanged.
