...
> Port of the community skill `site-architecture` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-site-architecture`; body unchanged.
