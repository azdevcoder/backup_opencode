...
> Port of the community skill `isms-audit-expert` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-isms-audit-expert`; body unchanged.
