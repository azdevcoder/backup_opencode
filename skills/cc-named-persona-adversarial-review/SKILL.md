---
name: cc-named-persona-adversarial-review
...
> Port of the community skill `named-persona-adversarial-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-named-persona-adversarial-review`; body unchanged.
