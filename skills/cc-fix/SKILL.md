...
> Port of the community skill `fix` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-fix`; body unchanged.
