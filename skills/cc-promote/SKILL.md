...
> Port of the community skill `promote` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-promote`; body unchanged.
