...
> Port of the community skill `board` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-board`; body unchanged.
