---
name: cc-business-investment-advisor
...
> Port of the community skill `business-investment-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-business-investment-advisor`; body unchanged.
