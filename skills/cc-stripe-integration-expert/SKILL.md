---
name: cc-stripe-integration-expert
...
> Port of the community skill `stripe-integration-expert` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-stripe-integration-expert`; body unchanged.
