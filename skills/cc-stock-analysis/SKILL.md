...
> Port of the community skill `stock-analysis` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-stock-analysis`; body unchanged.
