...
> Port of the community skill `collab-proof` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-collab-proof`; body unchanged.
