---
name: cc-ux-researcher-designer
...
> Port of the community skill `ux-researcher-designer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ux-researcher-designer`; body unchanged.
