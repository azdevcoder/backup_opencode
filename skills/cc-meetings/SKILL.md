...
> Port of the community skill `meetings` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-meetings`; body unchanged.
