...
> Port of the community skill `spec-to-repo` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-spec-to-repo`; body unchanged.
