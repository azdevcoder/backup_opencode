...
> Port of the community skill `linkedin-profile` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-linkedin-profile`; body unchanged.
