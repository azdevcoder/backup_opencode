---
name: cc-observability-designer
...
> Port of the community skill `observability-designer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-observability-designer`; body unchanged.
