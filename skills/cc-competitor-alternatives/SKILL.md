---
name: cc-competitor-alternatives
...
> Port of the community skill `competitor-alternatives` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-competitor-alternatives`; body unchanged.
