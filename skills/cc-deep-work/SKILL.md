...
> Port of the community skill `deep-work` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-deep-work`; body unchanged.
