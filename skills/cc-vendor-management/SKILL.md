...
> Port of the community skill `vendor-management` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-vendor-management`; body unchanged.
