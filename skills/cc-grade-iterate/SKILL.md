...
> Port of the community skill `grade-iterate` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-grade-iterate`; body unchanged.
