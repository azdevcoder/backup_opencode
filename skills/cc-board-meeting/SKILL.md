...
> Port of the community skill `board-meeting` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-board-meeting`; body unchanged.
