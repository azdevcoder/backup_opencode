...
> Port of the community skill `wrap-up` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-wrap-up`; body unchanged.
