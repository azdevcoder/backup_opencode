---
name: cc-markdown-html-orchestrator
...
> Port of the community skill `markdown-html-orchestrator` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-markdown-html-orchestrator`; body unchanged.
