...
> Port of the community skill `dossier` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-dossier`; body unchanged.
