...
> Port of the community skill `cto-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cto-review`; body unchanged.
