...
> Port of the community skill `market-research` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-market-research`; body unchanged.
