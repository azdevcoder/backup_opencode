...
> Port of the community skill `ab-test-setup` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-ab-test-setup`; body unchanged.
