...
> Port of the community skill `product-analytics` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-product-analytics`; body unchanged.
