...
> Port of the community skill `embedded-iot-mentor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-embedded-iot-mentor`; body unchanged.
