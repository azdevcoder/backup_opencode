...
> Port of the community skill `cloud-security` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cloud-security`; body unchanged.
