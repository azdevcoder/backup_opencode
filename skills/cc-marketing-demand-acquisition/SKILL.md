---
name: cc-marketing-demand-acquisition
...
> Port of the community skill `marketing-demand-acquisition` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-marketing-demand-acquisition`; body unchanged.
