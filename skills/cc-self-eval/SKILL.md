...
> Port of the community skill `self-eval` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-self-eval`; body unchanged.
