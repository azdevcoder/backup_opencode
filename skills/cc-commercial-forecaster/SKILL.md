...
> Port of the community skill `commercial-forecaster` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-commercial-forecaster`; body unchanged.
