...
> Port of the community skill `executive-mentor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-executive-mentor`; body unchanged.
