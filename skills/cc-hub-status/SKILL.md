...
> Port of the community skill `hub-status` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-hub-status`; body unchanged.
