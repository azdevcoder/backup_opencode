---
name: cc-c-level-advisor-chief-customer-officer-advisor
...
> Port of the community skill `chief-customer-officer-advisor` (source `c-level-advisor/skills/chief-customer-officer-advisor/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-c-level-advisor-chief-customer-officer-advisor` (duplicate upstream name); body rebuilt with the upstream opencode transform.
