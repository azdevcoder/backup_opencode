---
name: cc-universal-scraping-architect
...
> Port of the community skill `universal-scraping-architect` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-universal-scraping-architect`; body unchanged.
