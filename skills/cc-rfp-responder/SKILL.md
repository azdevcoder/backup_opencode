...
> Port of the community skill `rfp-responder` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-rfp-responder`; body unchanged.
