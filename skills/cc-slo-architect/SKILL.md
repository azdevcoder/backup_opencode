...
> Port of the community skill `slo-architect` (source `engineering/skills/slo-architect/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-slo-architect` (duplicate upstream name); body rebuilt with the upstream opencode transform.
