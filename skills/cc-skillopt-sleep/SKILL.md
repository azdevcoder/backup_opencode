...
> Port of the community skill `skillopt-sleep` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-skillopt-sleep`; body unchanged.
