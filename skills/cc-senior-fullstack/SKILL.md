...
> Port of the community skill `senior-fullstack` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-fullstack`; body unchanged.
