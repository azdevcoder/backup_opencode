...
> Port of the community skill `code-tour` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-code-tour`; body unchanged.
