...
> Port of the community skill `capture` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-capture`; body unchanged.
