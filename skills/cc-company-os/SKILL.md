...
> Port of the community skill `company-os` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-company-os`; body unchanged.
