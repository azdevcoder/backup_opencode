...
> Port of the community skill `x-twitter-growth` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-x-twitter-growth`; body unchanged.
