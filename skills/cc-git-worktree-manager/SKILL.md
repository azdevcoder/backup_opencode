...
> Port of the community skill `git-worktree-manager` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-git-worktree-manager`; body unchanged.
