---
name: cc-customer-success-manager
...
> Port of the community skill `customer-success-manager` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-customer-success-manager`; body unchanged.
