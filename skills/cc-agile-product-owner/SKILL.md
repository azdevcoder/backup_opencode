...
> Port of the community skill `agile-product-owner` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-agile-product-owner`; body unchanged.
