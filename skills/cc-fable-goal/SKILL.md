...
> Port of the community skill `fable-goal` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-fable-goal`; body unchanged.
