...
> Port of the community skill `local-seo-manager` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-local-seo-manager`; body unchanged.
