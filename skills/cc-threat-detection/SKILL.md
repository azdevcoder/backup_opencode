...
> Port of the community skill `threat-detection` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-threat-detection`; body unchanged.
