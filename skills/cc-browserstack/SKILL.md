...
> Port of the community skill `browserstack` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-browserstack`; body unchanged.
