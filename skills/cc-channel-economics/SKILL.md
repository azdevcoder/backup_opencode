...
> Port of the community skill `channel-economics` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-channel-economics`; body unchanged.
