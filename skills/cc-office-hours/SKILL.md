...
> Port of the community skill `office-hours` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-office-hours`; body unchanged.
