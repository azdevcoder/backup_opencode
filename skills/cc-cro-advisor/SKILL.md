...
> Port of the community skill `cro-advisor` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-cro-advisor`; body unchanged.
