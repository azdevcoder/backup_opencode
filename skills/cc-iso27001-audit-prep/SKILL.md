...
> Port of the community skill `iso27001-audit-prep` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-iso27001-audit-prep`; body unchanged.
