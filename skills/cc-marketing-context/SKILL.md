...
> Port of the community skill `marketing-context` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-marketing-context`; body unchanged.
