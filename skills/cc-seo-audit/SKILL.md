...
> Port of the community skill `seo-audit` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-seo-audit`; body unchanged.
