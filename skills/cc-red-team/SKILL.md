...
> Port of the community skill `red-team` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-red-team`; body unchanged.
