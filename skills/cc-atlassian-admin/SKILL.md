...
> Port of the community skill `atlassian-admin` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-atlassian-admin`; body unchanged.
