...
> Port of the community skill `snowflake-development` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-snowflake-development`; body unchanged.
