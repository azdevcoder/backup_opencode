...
> Port of the community skill `eu-ai-act-specialist` (source `ra-qm-team/compliance-team-eu-ai-act/skills/eu-ai-act-specialist/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-eu-ai-act-specialist` (duplicate upstream name); body rebuilt with the upstream opencode transform.
