...
> Port of the community skill `sales-engineer` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-sales-engineer`; body unchanged.
