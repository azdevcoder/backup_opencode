...
> Port of the community skill `senior-devops` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-senior-devops`; body unchanged.
