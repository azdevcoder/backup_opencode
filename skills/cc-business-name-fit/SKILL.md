...
> Port of the community skill `business-name-fit` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-business-name-fit`; body unchanged.
