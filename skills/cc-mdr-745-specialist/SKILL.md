...
> Port of the community skill `mdr-745-specialist` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-mdr-745-specialist`; body unchanged.
