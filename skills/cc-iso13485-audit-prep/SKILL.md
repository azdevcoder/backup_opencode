...
> Port of the community skill `iso13485-audit-prep` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-iso13485-audit-prep`; body unchanged.
