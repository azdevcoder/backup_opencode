...
> Port of the community skill `codebase-onboarding` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-codebase-onboarding`; body unchanged.
