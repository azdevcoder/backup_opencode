...
> Port of the community skill `gc-review` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-gc-review`; body unchanged.
