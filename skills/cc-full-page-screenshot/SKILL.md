...
> Port of the community skill `full-page-screenshot` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-full-page-screenshot`; body unchanged.
