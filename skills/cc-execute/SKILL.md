...
> Port of the community skill `execute` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-execute`; body unchanged.
