...
> Port of the community skill `browser-automation` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-browser-automation`; body unchanged.
