...
> Port of the community skill `vpe-advisor` (source `c-level-advisor/skills/vpe-advisor/SKILL.md`) from alirezarezvani/claude-skills for OpenCode. Name disambiguated as `cc-vpe-advisor` (duplicate upstream name); body rebuilt with the upstream opencode transform.
