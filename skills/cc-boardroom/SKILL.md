...
> Port of the community skill `boardroom` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-boardroom`; body unchanged.
