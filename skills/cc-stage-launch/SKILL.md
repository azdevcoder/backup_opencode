...
> Port of the community skill `stage-launch` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-stage-launch`; body unchanged.
