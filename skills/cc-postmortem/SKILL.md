...
> Port of the community skill `postmortem` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-postmortem`; body unchanged.
