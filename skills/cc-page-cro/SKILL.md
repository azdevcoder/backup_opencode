...
> Port of the community skill `page-cro` from alirezarezvani/claude-skills (upstream opencode conversion) for OpenCode. Directory and `name:` prefixed as `cc-page-cro`; body unchanged.
